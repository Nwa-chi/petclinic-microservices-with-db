...
AWS_REGION=$AWS_REGION helm repo add stable-petclinic s3://petclinic-helm-charts-nwachi/stable/myapp/ || echo "repository name already exists"
...
AWS_REGION=$AWS_REGION helm upgrade --install \
    petclinic-app-release stable-petclinic/petclinic_chart --version ${BUILD_NUMBER} --set DNS_NAME='qa.nwachi.click' \
